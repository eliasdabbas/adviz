...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'adviz'},
  'syms': { 'adviz.ecdf': {'adviz.ecdf.ecdf': ('ecdf.html#ecdf', 'adviz/ecdf.py')},
            ...
            'adviz.serp_heatmap': { 'adviz.serp_heatmap._concat': ('serp_heatmap.html#_concat', 'adviz/serp_heatmap.py'),
                                    'adviz.serp_heatmap._serp_heatmap_panel': ( 'serp_heatmap.html#_serp_heatmap_panel',
                                                                                'adviz/serp_heatmap.py'),
