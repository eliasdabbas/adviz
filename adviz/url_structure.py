...
Docs: https://eliasdabbas.github.io/adviz/url_structure.html.md"""
...
# %% ../nbs/02_url_structure.ipynb #8f7d9627-62d5-439d-ad73-39751b00f2bf
...
# %% ../nbs/02_url_structure.ipynb #847d8539-fd4d-4f99-86f4-4dfe3b7a580a
_texttemplate = "<b>%{label} </b><br><br>Directory: <b>%{parent}/%{label}</b><br>Count: %{value:,}<br>%{percentParent:.1%} of %{parent}<br>"

# %% ../nbs/02_url_structure.ipynb #6ef4c19b-3cb0-4fe5-b85e-e83bdb4d496c
def url_structure(
    url_list,
    items_per_level=10,
    height=600,
